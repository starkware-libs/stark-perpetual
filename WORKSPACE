...
http_archive(
    ...
    strip_prefix = "cairo",
    url = "https://github.com/starkware-libs/cairo/releases/download/v2.0.0-rc4/release-x86_64-unknown-linux-musl.tar.gz",
)
...
load(":load_cairo_lang.bzl", "load_cairo_lang")
