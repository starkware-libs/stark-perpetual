...
PROGRAM_PATH = os.path.join(CURRENT_DIR, "perpetual_cairo_compiled.json")
HASH_RELATIVE_SRC_PATH = "src/services/perpetual/cairo/program_hash.json"
COMMAND = "generate_perpetual_cairo_program_hash"
...
if __name__ == "__main__":
    program_hash_test_main(
        ...
        hash_path=get_source_dir_path(HASH_RELATIVE_SRC_PATH),
        command=COMMAND,
    )
