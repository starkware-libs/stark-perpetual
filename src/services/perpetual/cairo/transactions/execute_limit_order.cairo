...
#   "I want to buy/sell up to 'amount_synthetic' synthetic for 'amount_collateral' collateral in the
#    ratio amount_synthetic/amount_collateral (or better) and pay at most 'amount_fee' in fees."
#
...
func execute_limit_order(
        ...
        carried_state : CarriedState*, batch_config : BatchConfig*, limit_order : LimitOrder*,
        actual_collateral, actual_synthetic, actual_fee) -> (
        pedersen_ptr : HashBuiltin*, range_check_ptr, ecdsa_ptr : SignatureBuiltin*,
    ...
    let (local range_check_ptr, local ecdsa_ptr,
