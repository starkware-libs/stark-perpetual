...
struct Trade:
    ...
    member party_a_order : LimitOrder*
    member party_b_order : LimitOrder*
    member actual_collateral : felt
    member actual_synthetic : felt
    member actual_a_fee : felt
    member actual_b_fee : felt
end
...
func execute_trade(
    ...
    let (pedersen_ptr : HashBuiltin*, range_check_ptr, ecdsa_ptr : SignatureBuiltin*,
        carried_state : CarriedState*) = execute_limit_order(
